...
const About = () => {
  ...
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-thrive-50 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="mb-6">About <span className="gradient-text">Thrive</span></h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card>
              <CardContent>
                <div className="w-16 h-16 bg-thrive-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-thrive-500">1</span>
                </div>
            ...
            <Card>
              <CardContent>
                <div className="w-16 h-16 bg-thrive-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-thrive-500">2</span>
                </div>
            ...
            <Card>
              <CardContent>
                <div className="w-16 h-16 bg-thrive-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-thrive-500">3</span>
                </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-center text-2xl mb-12">Our Team</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Team Member 1 */}
            <div className="flex flex-col items-center">
              <img
                src="/Assets/IMG_0215.JPG"  // Replace with actual image path or URL
                alt="Min Phanith"
                className="w-32 h-32 rounded-full mb-4 object-cover"
              />
              <h3 className="text-xl font-semibold mb-1">Min Phanith</h3>
              <p className="text-thrive-500 mb-3">Co-Founder & CEO</p>
              <p className="text-gray-600 text-center">
                Former HR executive with 15+ years of experience in talent acquisition.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <img
                src="/path/to/photo2.jpg"  // Replace with actual image path or URL
                alt="Rath Chhneoum"
                className="w-32 h-32 rounded-full mb-4 object-cover"
              />
              <h3 className="text-xl font-semibold mb-1">Rath Chhneoum</h3>
              <p className="text-thrive-500 mb-3">Co-Founder & CTO</p>
              <p className="text-gray-600 text-center">
                AI expert who previously built recommendation systems at leading tech companies.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <img
                src="/path/to/photo3.jpg"  // Replace with actual image path or URL
                alt="Ly Hour"
                className="w-32 h-32 rounded-full mb-4 object-cover"
              />
              <h3 className="text-xl font-semibold mb-1">Ly Hour</h3>
              <p className="text-thrive-500 mb-3">Chief Product Officer</p>
              <p className="text-gray-600 text-center">
                Product visionary focused on creating intuitive, user-centered experiences.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <img
                src="/path/to/photo4.jpg"  // Replace with actual image path or URL
                alt="Ly Keasing"
                className="w-32 h-32 rounded-full mb-4 object-cover"
              />
